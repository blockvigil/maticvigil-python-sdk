...
class EVCore(object):
    ...
    #     try:
    #         os.stat(pwd.getpwuid(os.getuid()).pw_dir + '/.maticvigil/contracts')
    #     except:
    #         os.mkdir(pwd.getpwuid(os.getuid()).pw_dir + '/.maticvigil/contracts')
    #     os.mkdir(pwd.getpwuid(os.getuid()).pw_dir + f'/.maticvigil/contracts/{app_name}')
    #     z.extractall(pwd.getpwuid(os.getuid()).pw_dir + f'/.maticvigil/contracts/{app_name}')
    #     sys.path.append(pwd.getpwuid(os.getuid()).pw_dir + f'/.maticvigil/contracts/{app_name}')
